...
async function onUpdateCredentialStateButtonPress(
  updateCredentialStateForUser: any,
) {
...
async function onAppleButtonPress(updateCredentialStateForUser: any) {
  ...
  try {
    ...
    const identityTokenn: any = appleAuthRequestResponse?.identityToken;
    const userEmail = decodeAppleToken(identityTokenn);
    return console.log('User Email:', userEmail);
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, styles.horizontal]}>
      <Text
        style={styles.header}
        onPress={() =>
          onUpdateCredentialStateButtonPress(updateCredentialStateForUser)
        }>
        Credential State
      </Text>
